...
Case studies are **non-authoritative** — they document one team's choices, not a recommended path. The authoritative bindings live in [`template/docs/02-process/`](../template/docs/02-process/) for Layer ② and the corresponding meta-doc [`_binding-a-new-process.md`](../template/docs/02-process/_binding-a-new-process.md). Case studies illustrate the meta-doc's instructions with end-to-end examples.
...
| ---------- | ------------------------------------------------------- | ----------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| 2026-05-16 | Digital Twin PoC (tacit-knowledge digital twin builder) | Layer ② Process — Scrum / CI-CD / BDD-TDD | [`2026-05-16_digital-twin-downstream-process-binding.md`](./2026-05-16_digital-twin-downstream-process-binding.md) |
