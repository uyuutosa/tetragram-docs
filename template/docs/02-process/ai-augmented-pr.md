...
>
> **What this file is not.** A tutorial for end users (that lives under [`../01-artefacts/user-manual/tutorials/`](../01-artefacts/user-manual/tutorials/)). A code-reading guide aimed at new contributors (that lives in [`code-tours.md`](./code-tours.md)). Documentation about AI-generated code at module level (that goes into the relevant [`../01-artefacts/detailed-design/`](../01-artefacts/detailed-design/) file with a Reading Order subsection).
...
- GitLab Description Templates — <https://docs.gitlab.com/user/project/description_01-artefacts/templates/>
