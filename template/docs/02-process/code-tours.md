...
>
> **What this file is not.** A user manual ([`../01-artefacts/user-manual/`](../01-artefacts/user-manual/)). A decision record ([`../01-artefacts/arc42/09-decisions/`](../01-artefacts/arc42/09-decisions/)). A detailed design spec ([`../01-artefacts/detailed-design/`](../01-artefacts/detailed-design/)). The Diátaxis framework Pentaglyph adopts for end-user docs is explicitly *not* meant to absorb contributor-onboarding artefacts; see <https://diataxis.fr/start-here/>.
...
- The change crosses a layer boundary documented in [`../01-artefacts/arc42/05-building-blocks/`](../01-artefacts/arc42/05-building-blocks/).
...
```json
{
  ...
  "steps": [
    ...
    },
    {
      ...
      "line": 1,
      "description": "Implementations must satisfy this interface. See [ADR-0023](../docs/01-artefacts/arc42/09-decisions/0023-payment-provider-abstraction.md) for the reasoning."
    },
    {
      "title": "Adapter",
...
| --- | --- |
| "What does this product do, end-to-end?" | [`../01-artefacts/user-manual/`](../01-artefacts/user-manual/) (Diátaxis) |
| "Why was this approach chosen?" | [`../01-artefacts/arc42/09-decisions/`](../01-artefacts/arc42/09-decisions/) (MADR) |
| "What is the design of this module?" | [`../01-artefacts/detailed-design/`](../01-artefacts/detailed-design/) |
