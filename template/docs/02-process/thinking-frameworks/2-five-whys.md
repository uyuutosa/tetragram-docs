...
- Especially good for **post-incident postmortems** (see [`../../01-artefacts/postmortems/`](../../01-artefacts/postmortems/))
...
This kit's [`../../01-artefacts/postmortems/`](../../01-artefacts/postmortems/) directory expects every Medium+ postmortem to include a 5 Whys section. The post-mortem template (when added) should reference this file as the canonical method.
