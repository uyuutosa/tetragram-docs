...
> **Layer ④ Governance.** This matrix is the default for downstream pentaglyph projects. Override by writing a same-named file in `<downstream>/docs/04-governance/`.
...
| **Process binding** (`02-process/<canon>.md`) | engineer proposing (R) | peer engineer (C) + PO (C) | PO (A) | team (I) |
...
- [ADR-0008](../01-artefacts/arc42/09-decisions/0008-governance-layer-contract.md) — the Layer ④ contract this file implements.
