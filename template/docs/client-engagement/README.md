...
- [`../templates/14_inception-deck.md`](../templates/14_inception-deck.md) — Agile Inception Deck for `CHARTER.md`
- [`../templates/15_weekly-update.md`](../templates/15_weekly-update.md) — Atlassian 4-block for `reports/YYMMDD/weekly.md`
- [`../templates/16_heartbeat.md`](../templates/16_heartbeat.md) — Basecamp + 6-pager prose for `reports/YYMMDD/heartbeat.md`
- [`../templates/17_daci-decision.md`](../templates/17_daci-decision.md) — DACI workflow for `daci/`
- [`../templates/18_raid-entry.md`](../templates/18_raid-entry.md) — single RAID entry format for `raid.md`
