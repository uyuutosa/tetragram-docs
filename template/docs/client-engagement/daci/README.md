...
- Pure engineering-internal decisions (use [`../../01-artefacts/arc42/09-decisions/`](../../01-artefacts/arc42/09-decisions/) directly with MADR).
- Decisions that need no contributor input (just write the MADR in `../decisions/`).
- One-person calls inside the engagement lead's authority (record as a brief note in [`../01-artefacts/reports/YYMMDD/weekly.md`](../01-artefacts/reports/)).

## Lifecycle

1. **Open**: Driver creates `YYYY-MM-DD-<slug>.md` from [`../../01-artefacts/templates/17_daci-decision.md`](../../01-artefacts/templates/17_daci-decision.md) with D/A/C/I roles assigned and the question stated.
...
- [`../01-artefacts/reports/YYMMDD/heartbeat.md`](../01-artefacts/reports/) narrates major in-flight decisions in prose.

## Related

- [`../README.md`](../README.md) — PEL overview
- [`../../01-artefacts/templates/17_daci-decision.md`](../../01-artefacts/templates/17_daci-decision.md) — DACI template
