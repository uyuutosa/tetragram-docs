...
- Anything that should remain current → put it in Layer A (e.g. `01-artefacts/arc42/10-quality/` for SLO benchmarks).
- Architectural decisions → write an ADR under `01-artefacts/arc42/09-decisions/` instead.
- Bug retrospectives → use [`../01-artefacts/postmortems/`](../01-artefacts/postmortems/).
