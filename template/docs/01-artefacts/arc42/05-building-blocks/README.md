...
**Implementation HOW does not live here.** Per-module implementation specs live under [`../../01-artefacts/detailed-design/`](../../01-artefacts/detailed-design/) (Template 3). This section is a **navigation index** that links to those files.

## How to write here

1. Use Template 1 (architecture-overview) trimmed to the §5 portion.
2. Names of containers and components must match exactly across §5, [`../../01-artefacts/diagrams/c4/workspace.dsl`](../../01-artefacts/diagrams/c4/workspace.dsl), and [`../../01-artefacts/detailed-design/`](../../01-artefacts/detailed-design/) — no synonyms.
...
- [`../../01-artefacts/diagrams/c4/workspace.dsl`](../../01-artefacts/diagrams/c4/workspace.dsl) — single source of truth for structural diagrams
- [`../../01-artefacts/detailed-design/`](../../01-artefacts/detailed-design/) — implementation specs (HOW)
