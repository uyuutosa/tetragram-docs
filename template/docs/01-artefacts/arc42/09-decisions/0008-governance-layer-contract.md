...
1. **What artefacts live in `04-governance/`**: a fixed set (`README.md`, `raci.md`, `adr-accept-protocol.md`, `override-justification.md`, `contributing.md`) plus dated `04-governance/<topic>-decision-YYYY-MM-DD.md` files for changes.
...
Per [ADR-0004](0004-layer-separation-contracts.md), Layer ④ writes only into `04-governance/`. Specifically:
...
- Pros:
  ...
  - `grep -r 04-governance/` lists the kit's governance surface.
...
- [ ] Implement 04-governance/ in the kit (Phase 4 of self-architecture roadmap — this ADR's batch).
...
- Verification:
  ...
  - Governance decision files use `01-artefacts/templates/12_governance-decision.md`.
...
- [`04-governance/README.md`](../../04-governance/README.md) — directory's authoritative navigation.
