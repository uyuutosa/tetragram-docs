...
The detailed layer contracts (DO / DON'T per layer + dependency direction) live in [`STRATEGY.md §3.2`](../../STRATEGY.md). The C4 L1/L2 view of the kit lives in [`01-artefacts/arc42/05-building-blocks/pentaglyph-self-architecture.md`](../05-building-blocks/pentaglyph-self-architecture.md).
...
- The kit can finally apply arc42 + C4 + MADR to itself ([`01-artefacts/arc42/05-building-blocks/pentaglyph-self-architecture.md`](../05-building-blocks/pentaglyph-self-architecture.md)).
