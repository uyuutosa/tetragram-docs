...
Always start from [`../../01-artefacts/templates/5_adr.md`](../../01-artefacts/templates/5_adr.md). Do not invent a homemade ADR format.
...
Maintain a section like the example below in your downstream `01-artefacts/arc42/09-decisions/README.md`. Group ADRs by theme. Start numbering at the next free number after the highest self-ADR.
