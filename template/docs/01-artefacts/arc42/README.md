...
| Template | Use for |
| -------- | ------- |
| [`../01-artefacts/templates/1_architecture-overview.md`](../01-artefacts/templates/1_architecture-overview.md) | §1 / §3 / §4 / §5 / §8 / §10 / §11 / §12 — most arc42 sections |
| [`../01-artefacts/templates/3_module-detailed-design.md`](../01-artefacts/templates/3_module-detailed-design.md) | Per-module detailed designs under [`../01-artefacts/detailed-design/`](../01-artefacts/detailed-design/) (linked from §5) |
| [`../01-artefacts/templates/4_use-case.md`](../01-artefacts/templates/4_use-case.md) | Use-case files under [`03-context-and-scope/use-cases/`](./03-context-and-scope/use-cases/) |
| [`../01-artefacts/templates/5_adr.md`](../01-artefacts/templates/5_adr.md) | ADRs under [`09-decisions/`](./09-decisions/) (MADR v3.0) |
