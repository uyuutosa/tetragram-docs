...
The C4 L1 diagram lives in [`../../01-artefacts/diagrams/c4/workspace.dsl`](../../01-artefacts/diagrams/c4/workspace.dsl). This section embeds an export or links to it.
...
- [`../../01-artefacts/diagrams/c4/`](../../01-artefacts/diagrams/c4/) — C4 L1 single source of truth
