...
> **Use Template 0** ([`../01-artefacts/templates/0_default.md`](../01-artefacts/templates/0_default.md)) or just the OpenAPI / schema file directly.
...
2. **Cross-link from the corresponding `../01-artefacts/detailed-design/<module>.md` §4.3 (API specification)**.
