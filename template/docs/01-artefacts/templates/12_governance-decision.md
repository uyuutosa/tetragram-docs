...
> **Lifecycle**: Layer A (Durable). Place at `04-governance/<topic>-decision-YYYY-MM-DD.md`. Append-only — never edit; supersede by a newer dated file.
...
| Affects file(s) | `04-governance/<changed-file>.md`, ... |
| Layer | 4 (Governance) |
...
<How was the team informed? Daily Scrum announcement / `01-artefacts/task-list/` retro entry / Slack / mailing list? Per `raci.md` the Informed parties for this artefact type should all see this within one Sprint of the decision.>
...
Lightweight form still goes in `04-governance/` (not `01-artefacts/task-list/`), to preserve grep-ability of all Layer ④ decisions.
