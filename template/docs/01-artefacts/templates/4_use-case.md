...
> **Copy to use**: `cp 01-artefacts/templates/4_use-case.md 01-artefacts/arc42/03-context-and-scope/use-cases/<use-case-name>.md`
> Recommended location: `01-artefacts/arc42/03-context-and-scope/use-cases/` (linked from arc42 §6 Runtime View)
...
| Related Tech Design  | [<module name>](../../../01-artefacts/detailed-design/<file>.md)            |
...
- Tech Design: [<module name>](../../../01-artefacts/detailed-design/<file>.md)
