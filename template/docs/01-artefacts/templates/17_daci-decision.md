...
> **Copy to use**: `cp 01-artefacts/templates/17_daci-decision.md client-engagement/daci/<YYYY-MM-DD>-<kebab-slug>.md`
...
>
> **When to use this template**: non-trivial, cross-functional decision with client visibility, currently in flight. For pure engineering-internal decisions, write a MADR directly under [`../01-artefacts/arc42/09-decisions/`](../01-artefacts/arc42/09-decisions/). For one-person calls inside the engagement lead's authority, record as a one-liner in the relevant `weekly.md`.
>
