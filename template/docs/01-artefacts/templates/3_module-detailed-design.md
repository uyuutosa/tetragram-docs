...
> **Copy to use**: `cp 01-artefacts/templates/3_module-detailed-design.md 01-artefacts/detailed-design/<module-name>.md`
> Recommended location: `01-artefacts/detailed-design/`
...
| Related PRD  | [<feature-name>_PRD](../01-artefacts/arc42/03-context-and-scope/prds/<file>.md) |
| Related ADRs | [ADR-NNNN](../01-artefacts/arc42/09-decisions/NNNN-<placeholder>.md) |
...
PRD: [<feature-name>_PRD](../01-artefacts/arc42/03-context-and-scope/prds/<file>.md)
...
<!-- Delegate detail to chapters under 01-artefacts/arc42/08-crosscutting/. Here, capture only concerns specific to this module. -->
...
- Estimated monthly cost: <value> (see [cost estimate](../01-artefacts/cost-estimates/<file>.md))
...
Cross-cutting ADRs (decisions that affect multiple modules) live as standalone files under 01-artefacts/arc42/09-decisions/NNNN-<placeholder>.md in MADR v3.0 format.
See: docs/01-artefacts/templates/5_adr.md -->
...
<!-- Error code list and retry policy. Cross-cutting strategy lives at 01-artefacts/arc42/08-crosscutting/error-strategy.md -->
...
- Related PRD: [<feature-name>_PRD](../01-artefacts/arc42/03-context-and-scope/prds/<file>.md)
- Related ADRs: [ADR-NNNN](../01-artefacts/arc42/09-decisions/NNNN-<placeholder>.md)
- Cross-cutting: [01-artefacts/arc42/08-crosscutting/](../01-artefacts/arc42/08-crosscutting/)
