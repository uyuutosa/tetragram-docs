...
> **Copy to use**: `cp 01-artefacts/templates/5_adr.md 01-artefacts/arc42/09-decisions/NNNN-<title-kebab-case>.md`
> Recommended location: `01-artefacts/arc42/09-decisions/` (cross-cutting ADRs); inside §7 of a Module Detailed Design (local ADRs, lightweight form)
