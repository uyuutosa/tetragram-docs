...
| 9   | [Sprint Retrospective](9_sprint-retro.md)                      | Process — sprint retrospective output | `01-artefacts/task-list/` (Layer B) | "What went well, what did not, what will we change?" |
| 10  | [PBI Refinement](10_refinement-pbi.md)                         | Process — product-backlog-item refinement | `01-artefacts/task-list/` (Layer B) | "Is this backlog item ready for the next sprint?" |
| 11  | [DoD Checklist](11_dod-checklist.md)                           | Process — Definition of Done | `02-process/dod-checklist.md` | "What does this team mean by *done*?" |
| 12  | [Governance Decision](12_governance-decision.md)               | Process — heavyweight governance-board decision | `04-governance/` | "Why did the governance board approve / reject this?" |
...
| 15  | [Weekly Update](15_weekly-update.md)                           | PEL short-form weekly (4-block)      | `client-engagement/01-artefacts/reports/<YYMMDD>/weekly.md` | "What happened this week, what's next?" |
| 16  | [Heartbeat](16_heartbeat.md)                                   | PEL long-form cyclical (narrative)   | `client-engagement/01-artefacts/reports/<YYMMDD>/heartbeat.md` | "What did this cycle add up to, what did we learn?" |
...
Before writing a document
    ...
    │   YES → Type 5: ADR (standalone file under `01-artefacts/arc42/09-decisions/`)
...
4. Record the change in an implementation note under `../01-artefacts/impl-plans/` or in an ADR under `../01-artefacts/arc42/09-decisions/`.
