...
> **Copy to use**: `cp 01-artefacts/templates/7_journey-map.md 01-artefacts/arc42/03-context-and-scope/journeys/<journey-id>.md`
> Recommended location: `01-artefacts/arc42/03-context-and-scope/journeys/` (linked from arc42 §3 Context and §6 Runtime)
...
| <engineering implication>                    | [<module>](../../../01-artefacts/detailed-design/<file>.md)           |
| <decision needed — record as ADR>            | New ADR under `01-artefacts/arc42/09-decisions/`                       |
