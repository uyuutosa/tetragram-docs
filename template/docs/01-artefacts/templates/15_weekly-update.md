...
> **Copy to use**: `cp 01-artefacts/templates/15_weekly-update.md client-engagement/01-artefacts/reports/<YYMMDD>/weekly.md`
> Recommended location: `client-engagement/01-artefacts/reports/<YYMMDD>/weekly.md`
