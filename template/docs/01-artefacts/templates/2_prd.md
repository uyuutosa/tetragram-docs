...
> **Copy to use**: `cp 01-artefacts/templates/2_prd.md <target-dir>/<feature-name>_PRD.md`
> Recommended location: `01-artefacts/arc42/03-context-and-scope/prds/`
...
**Traceability**: each FR links to its corresponding [Use Case](../use-cases/) and [Tech Design](../../01-artefacts/detailed-design/). E2E coverage is tracked per `FR-<CAT>-NNN`.

### 5.1 Functional requirements

| ID                    | Requirement | Priority           | Acceptance Criteria (Given/When/Then)                        | Related                                                      |
| --------------------- | ----------- | ------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **FR-XXXX-001**       | <title>     | Must/Should/Could  | Given <state><br>When <action><br>Then <result>              | [Tech Design](../../01-artefacts/detailed-design/<file>.md) §X / [Use Case](../use-cases/<file>.md) |
| **FR-XXXX-002**       | …           | Must               | …                                                            | …                                                            |
...
- Detailed design (Type 3): [<module name>](../../01-artefacts/detailed-design/<file>.md)
