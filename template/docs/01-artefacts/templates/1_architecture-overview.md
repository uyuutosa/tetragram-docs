...
> **Copy to use**: `cp 01-artefacts/templates/1_architecture-overview.md <target-dir>/<title>.md`
> Recommended location: `01-artefacts/arc42/01-introduction-and-goals/overview.md` (top-level) or `01-artefacts/arc42/08-crosscutting/<concern>.md`
...
| --- | --------------------------------------- | ------------------------------------------------------------ |
| 1   | <e.g. Adopt framework X>                | [ADR-0001](../01-artefacts/arc42/09-decisions/0001-<placeholder>.md)      |
| 2   | <e.g. Direct streaming over polling>    | [ADR-0002](../01-artefacts/arc42/09-decisions/0002-<placeholder>.md)      |
...
<!-- Delegate detail to files under 01-artefacts/arc42/08-crosscutting/. Here, list which concerns are addressed and link out. -->
...
| ------------------------------------------------------------ | -------- | --------- | ---------- |
| [ADR-0001](../01-artefacts/arc42/09-decisions/0001-<placeholder>.md)      | <Title>  | Accepted  | YYYY-MM-DD |
