...
> **Copy to use**: `cp 01-artefacts/templates/6_persona.md 01-artefacts/arc42/03-context-and-scope/personas/<persona-id>.md`
> Recommended location: `01-artefacts/arc42/03-context-and-scope/personas/` (linked from arc42 §3 Context)
