...
> **Copy to use**: `cp 01-artefacts/templates/14_inception-deck.md client-engagement/CHARTER.md`
...
<!-- One or two architecture sketches or wireframes. C4 L1 from ../01-artefacts/diagrams/c4/ is often the right fit.
     Show the *shape* of the solution. Detail comes later. -->

<C4 L1 system context, or hand-drawn box diagram, or screenshot mockup>

Reference: [`../01-artefacts/diagrams/c4/`](../01-artefacts/diagrams/c4/) for the architecture renders.
