...
> **Copy to use**: `cp 01-artefacts/templates/8_service-blueprint.md 01-artefacts/arc42/03-context-and-scope/blueprints/<service-id>.md`
> Recommended location: `01-artefacts/arc42/03-context-and-scope/blueprints/` (linked from arc42 §3 Context and §6 Runtime)
...
| Module specs of involved systems             | [<module>](../../../01-artefacts/detailed-design/<file>.md)          |
