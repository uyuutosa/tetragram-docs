...
- **PEL artefacts** (`client-engagement/reports/`, `daci/`, `decisions/`) should all be Pyramid-structured
...
- [`../../client-engagement/reports/README.md`](../../client-engagement/reports/README.md) — PEL reports apply Pyramid by convention
